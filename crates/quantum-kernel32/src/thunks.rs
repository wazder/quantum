...
fn resolve_kernel32(function: &str) -> Option<u64> {
    let ptr: *const () = match function {
        ...
        // File I/O
        "CreateFileA" => crate::stubs::CreateFileA as *const (),
        "CreateFileW" => crate::stubs::CreateFileW as *const (),
        "ReadFile" => crate::stubs::ReadFile as *const (),
        "FlushFileBuffers" => crate::stubs::FlushFileBuffers as *const (),
        "SetFilePointer" => crate::stubs::SetFilePointer as *const (),
        "SetFilePointerEx" => crate::stubs::SetFilePointerEx as *const (),
        "SetEndOfFile" => crate::stubs::SetEndOfFile as *const (),
        "GetFileSize" => crate::stubs::GetFileSize as *const (),
        ...
        "HeapReAlloc" => crate::stubs::HeapReAlloc as *const (),
        "HeapSize" => crate::stubs::HeapSize as *const (),
